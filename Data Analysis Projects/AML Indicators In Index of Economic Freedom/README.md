...
For the purpose of the analysis I have edited columns in the dataset to assist with querying, and have created aggregated data as part of this analysis. The data license can be found in the folder. 
